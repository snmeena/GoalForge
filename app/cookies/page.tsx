...
import { ArrowLeft, Cookie, Database, Info } from "lucide-react";
      ...
      <article className="glass-card w-full max-w-[720px] p-6 sm:p-10 relative z-10 rounded-3xl bg-[var(--bg-surface)]/80 border border-[var(--border)] backdrop-blur-xl shadow-[0_20px_60px_rgba(0,0,0,0.4)] flex flex-col transition-all duration-500 hover:shadow-[0_20px_80px_rgba(0,0,0,0.6)]">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-5 mb-8 border-b border-[var(--border)] pb-8">
          <div className="w-14 h-14 shrink-0 rounded-2xl border-2 border-[var(--border)] bg-[var(--bg-base)] text-primary flex items-center justify-center shadow-inner relative overflow-hidden group">
            ...
            <Cookie size={26} strokeWidth={2.5} className="relative z-10 group-hover:scale-110 transition-transform duration-300" />
          </div>
          <div>
        ...
        <p className="mb-8 text-[14px] font-medium text-primary leading-relaxed bg-[var(--bg-base)] p-4 rounded-[14px] border border-[var(--border)] shadow-inner">
          GoalForge values structural transparency. This breakdown details exactly why and how we use local browser storage matrices.
        </p>
        ...
        <div className="mb-6">
          <h2 className="text-[15px] font-bold text-primary flex items-center gap-3 mb-2">
            ...
            1. Functional Local Storage
          </h2>
          <p className="text-[13.5px] leading-relaxed text-muted pl-11">
            We do not use tracking or advertising cookies. We only access essential local session context identifiers to hold your interface configuration (such as keeping Dark Mode locked across page reloads) and stay active inside your private workspace dashboard.
          </p>
        </div>
        ...
        <div className="mb-2">
          ...
          <p className="text-[13.5px] leading-relaxed text-muted pl-11">
            You can choose to delete your cookies and purge local cache storage files through your individual browser system configurations at any moment. Note that this might require manual re-authentication parameters upon entering your dashboard workspace again.
          </p>
        </div>
      </article>
    </div>
